...
(function () {
  ...
  var FA = {
    ...
    "hero-deck": "همه ما تجربه‌ها، احساسات و عواطفی را حمل می‌کنیم که با گذشت زمان در هم تنیده می‌شوند، مانند رشته‌هایی که به هم بافته شده و ریسمان وجود ما را تشکیل می‌دهند. 🧶",
    ...
    "dossier-subtitle": "  بازتاب تلاش‌ کسانی که خود را وقف خلق بستری معنادار در روان‌شناسی و علوم انسانی کرده‌اند.",
    "dossier-founding": "تأسیس",
    "dossier-date": "۲۰ آبان ۱۴۰۲",
    "dossier-campus-lbl": "دانشگاه",
    "dossier-freq-lbl": "دوره انتشار",
    "dossier-freq-val": "دوماهنامه",
    "dossier-scope-val": "۵ محور اصلی",

    "about-started": "همه چیز در ۲۰ آبان ۱۴۰۲ آغاز شد...",
